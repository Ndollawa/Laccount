...
import { useAddNewEMailTemplateMutation } from '../../slices/mailerApi.slice';
...
const CreateEMailTemplateForm = () => {
  ...
  const [addNewEMailTemplate, { isLoading, isSuccess, isError, error }] = useAddNewEMailTemplateMutation();
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (formFields, e) => {
    ...
    // formData.append("context", formFields.context);
    ...
    await addNewEMailTemplate(formFields);
  };
    ...
    <>
      ...
      <ModalComponent
        {...{
          ...
          header: { show: true, title: "Add New E-Mail Template" },
              ...
              <div className="row">
                ...
                <div className="mb-3 col-md-4">
                  ...
                  <select className="form-control" {...register("type")}>
                    <option value={MailerTemplateEnum.ACCOUNT_VERIFICATION}>
                      Account Verification
                    </option>
                    <option value={MailerTemplateEnum.SIGNUP_CONFIRMATION}>
                      Signup Confirmation
                    </option>
                    <option value={MailerTemplateEnum.LOGIN_CONFIRMATION}>
                      Sigin Confirmation
                    </option>
                    <option value={MailerTemplateEnum.PASSWORD_RESET}>
                      Password Reset
                    </option>
                    <option value={MailerTemplateEnum.PAYMENT_RECEIPT}>
                      Payment Receipt
                    </option>
                    <option value={MailerTemplateEnum.PROMOTIONAL_OFFER}>
                      Promotional Offers
                    </option>
                    <option value={MailerTemplateEnum.SUBSCRIPTION_RENEWAL}>
                      Subscription Renewal
                    </option>
                    <option value={MailerTemplateEnum.SYSTEM_NOTIFICATION}>
                      System Notification
                    </option>
                    <option value={MailerTemplateEnum.NEWSLETTER}>
                      News Letter
                    </option>
