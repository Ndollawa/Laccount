        ...
        <ul className="navbar-nav header-right main-notification">
          ...
          <li className="nav-item dropdown notification_dropdown">
            <Link className={`nav-link ai-icon ${toggleNotification ? 'show' : ''}`} to="" onClick={() => setToggleNotification(!toggleNotification)}>
              <svg className="bell-icon" width="24" height="24" viewBox="0 0 28 28" fill="currentColor">
                            ...
                            <li className="nav-item dropdown header-profile">
                                <Link className="nav-link" to="#" role="button"  onClick={()=>{
									...
									<div className="header-info">
										<span>{ (currentUser?.firstName+" "+currentUser?.lastName) || currentUser?.username}</span>
